...
|List Back|$$O\left(n*m\right)=O\left(n\right)$$|$$O\left(n*m\log_2\left(m\right)\right)=O\left(n\right)$$|
|List Get by Index|$$O\left(n*m\right)=O\left(n\right)$$|$$O\left(n*m\right)=O\left(n\right)$$|
